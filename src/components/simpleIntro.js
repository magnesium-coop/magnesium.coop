        ...
        <div className="h-full w-full"
          ...
          <div className="h-full flex flex-col z-40 items-center justify-around">
            ...
            <div className="w-full flex justify-around ">
              <button className={"self-end text-5xl md:text-5xl lg:text-6xl text-naranja"}
                 onClick={(e) => {
                   e.preventDefault()
                   props.fullPageApi.moveTo("nosotros", 0)
                 }}>
              <span className="mx-auto">
                <animated.svg style={pulseProps} stroke="currentColor" fill="currentColor" strokeWidth="0"
